...
const onCustomModelInput = () => { if (customModel.value) selectedModel.value = '' }
const onCustomIssueInput = () => { if (customIssue.value) selectedIssue.value = '' }
