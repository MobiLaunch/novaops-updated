    ...
    <div class="grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-6 items-start">
      ...
      <div class="rounded-2xl p-6 space-y-5"
          ...
          <div class="rounded-xl p-4 space-y-4"
            ...
            <div v-if="marketPriceResult" class="space-y-2">
              <div class="grid grid-cols-3 gap-3">
                <div class="rounded-xl p-3 text-center" style="background: hsl(var(--muted)/0.4)">
                ...
                <div class="rounded-xl p-3 text-center" style="background: #f59e0b14; outline: 1px solid #f59e0b30; outline-offset: 0">
          ...
          <div class="space-y-2">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-2">
              <button v-for="issue in functionalIssues" :key="issue.value"
                class="flex items-center gap-2.5 p-3 rounded-xl text-left transition-all text-xs font-bold"
            ...
            <div class="space-y-2">
              ...
              <div class="space-y-1.5">
                <button v-for="acc in accessoryOptions" :key="acc.value"
                  class="w-full flex items-center gap-3 p-3 rounded-xl text-xs font-bold transition-all"
        ...
        <div v-if="currentStep === 4" class="space-y-5">
          ...
          <!-- Pricing breakdown -->
          <div class="rounded-xl overflow-hidden" style="outline: 1.5px solid hsl(var(--border)/0.6); outline-offset: 0">
